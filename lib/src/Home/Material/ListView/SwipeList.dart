...
class SwipeList extends StatefulWidget {
  @override
  _SwipeList createState() => _SwipeList();
}
...
// if device orientation is horizontal then set widget by this function
...
//A delegate that creates slide action
...
// Function For SnackBar
  void _showSnackBar(BuildContext context, String text) {
    Scaffold.of(context).showSnackBar(
        SnackBar(backgroundColor: theamColor, content: Text(text)));
  }
}
