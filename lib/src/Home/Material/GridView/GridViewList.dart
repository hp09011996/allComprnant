...
import 'package:flutter_ui_compornent/src/Home/Material/GridView/ListGrid.dart';
import 'package:flutter_ui_compornent/src/Home/Material/GridView/RoundGrid.dart';
import 'package:flutter_ui_compornent/src/Home/Material/GridView/SimpleGrid.dart';
...
class GridViewList extends StatefulWidget {
  const GridViewList(this.widgetM);
...
class _GridViewListState extends State<GridViewList> {
  final List<dynamic> list = [SimpleGrid(), RoundGrid(), ListGrid()];
  @override
