...
class SimpleSegment extends StatefulWidget {
  @override
  _SimpleSegment createState() => _SimpleSegment();
}

class _SimpleSegment extends State<SimpleSegment>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Simple Segment'),
